...
REQUIRED_PATHS = [
    ...
    ".agent/.codex/instructions.md",
    ".agent/.codex/project_context.md",
    ".agent/.codex/tasks.md",
    ".agent/.claude/settings.json",
    ".agent/.claude/commands/run_tests.md",
    ".agent/.claude/commands/inspect_project.md",
    ".agent/.claude/commands/plan_experiment.md",
    ".agent/AGENTS.md",
    ".agent/CLAUDE.md",
    ".agent/VIBE.md",
    "configs/config.yaml",
    ...
    "data/metadata/events_example.csv",
